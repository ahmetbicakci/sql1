...
-- Ismi Ali olanlarin urun_fiyatlarini %15 artirin 

update mart_satislar
set urun_fiyat = urun_fiyat * 1.15
where musteri_isim = 'Ali';

-- Ismi A il baslayan butun musterilerin  urun_fiyatlarini %15 artirin 
...
-- 
-- Honda araclarin urun id'sini 50 yapin.
